...
/**
* TransmissionNetworkSearch represents the model behind the search form about `app\models\TransmissionNetwork`.
*/
class TransmissionNetworkSearch extends TransmissionNetwork
{
    ...
    {
        $query = TransmissionNetwork::find();
