...
use Yii;
use app\models\base\InstalationSubtype as BaseInstalationSubtype;
use fredyns\stringcleaner\StringCleaner;
use yii\helpers\ArrayHelper;

/**
 * This is the model class for table "instalation_subtype".
 *
...
class InstalationSubtype extends BaseInstalationSubtype
{
    ...
    {
        if ($plural){
            return Yii::t('models', 'Instalation Subtypes');
        } else{
            return Yii::t('models', 'Instalation Subtype');
        }
    }
