...
/**
 * This is the base-model class for table "fuel".
 *
 * @property integer $id
 ...
 */
abstract class Fuel extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\InstalationGenerator::className(), ['fuel_id' => 'id']);
    }
