...
/**
 * This is the base-model class for table "transmission_network".
 *
 * @property integer $id
 ...
 */
abstract class TransmissionNetwork extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\InstalationTransmission::className(), ['network_id' => 'id']);
    }
