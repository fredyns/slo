...
/**
 * This is the base-model class for table "technical_personel".
 *
 * @property integer $id
 ...
 */
abstract class TechnicalPersonel extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\Submission::className(), ['technical_personel_id' => 'id']);
    }
