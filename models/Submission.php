...
class Submission extends BaseSubmission
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'instalation_country_id' => Yii::t('models', 'Instalation Country ID'),
            'instalation_province_id' => Yii::t('models', 'Instalation Province ID'),
            'instalation_regency_id' => Yii::t('models', 'Instalation Regency ID'),
            'instalation_latitude' => Yii::t('models', 'Instalation Latitude'),
            'instalation_longitude' => Yii::t('models', 'Instalation Longitude'),
            'bussiness_type_id' => Yii::t('models', 'Bussiness Type ID'),
            'sbu_id' => Yii::t('models', 'Sbu ID'),
            'technical_pic_id' => Yii::t('models', 'Technical Pic ID'),
            'technical_personel_id' => Yii::t('models', 'Technical Personel ID'),
            'report_number' => Yii::t('models', 'Report Number'),
            'report_file_id' => Yii::t('models', 'Report File ID'),
