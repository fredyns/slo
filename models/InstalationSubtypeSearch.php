...
/**
* InstalationSubtypeSearch represents the model behind the search form about `app\models\InstalationSubtype`.
*/
class InstalationSubtypeSearch extends InstalationSubtype
{
