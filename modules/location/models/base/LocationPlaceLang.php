 ...
 */
abstract class LocationPlaceLang extends \yii\db\ActiveRecord
{
    ...
    {
        if($plural){
            return Yii::t('location-model', 'LocationPlaceLangs');
        }else{
            return Yii::t('location-model', 'LocationPlaceLang');
        }
    }
