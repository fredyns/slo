...
?>
<div class="giiant-crud technical-personel-view">
    ...
    <div style='position: relative'>
        <div style='position:absolute; right: 0px; top: 0px;'>
            ...
            Html::a(
                ...
                ['submission/create', 'Submission' => ['technical_personel_id' => $model->id]],
                ['class'=>'btn btn-success btn-xs']
            );
            ?>
        </div>
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['Submission'] = ['technical_personel_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
