...
?>
<div class="giiant-crud voltage-view">
    ...
    <div style='position: relative'>
        <div style='position:absolute; right: 0px; top: 0px;'>
            ...
            Html::a(
                ...
                ['instalation-transmission/create', 'InstalationTransmission' => ['voltage_id' => $model->id]],
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    ...
                    $params['InstalationTransmission'] = ['voltage_id' => $model->primaryKey()[0]];
                    return $params;
                },
                'buttons' => [
