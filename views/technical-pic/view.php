...
?>
<div class="giiant-crud technical-pic-view">
    ...
    <div style='position: relative'>
        <div style='position:absolute; right: 0px; top: 0px;'>
            ...
            Html::a(
                ...
                ['submission/create', 'Submission' => ['technical_pic_id' => $model->id]],
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    ...
                    $params['Submission'] = ['technical_pic_id' => $model->primaryKey()[0]];
                    return $params;
                },
                'buttons'    => [
